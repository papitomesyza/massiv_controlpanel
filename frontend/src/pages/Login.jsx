  ...
  return (
    <div style={{
      ...
      <div style={{ width: '100%', maxWidth: '380px' }}>
          ...
          {logo ? (
            ...
            <>
              <div style={{
                ...
                justifyContent: 'center',
                margin: '0 auto 20px',
                boxShadow: '0 8px 32px var(--overlay-05)',
                fontSize: '24px',
                fontWeight: 800,
              ...
              <h1 style={{ fontSize: '32px', fontWeight: 700, letterSpacing: '-0.5px', marginBottom: '8px', color: 'var(--color-ink)' }}>
                {agencyName}
              </h1>
              <p style={{ color: 'var(--color-mid-gray)', fontSize: '14px' }}>{tagline || 'Creative Agency OS'}</p>
            </>
          )}
        </div>
        ...
        <p style={{ textAlign: 'center', color: 'var(--color-mid-gray)', fontSize: '11px', marginTop: '24px' }}>
          built by year28
        </p>
      </div>
    </div>
